export default {
    ...
    config: {
        ...
        importUrl: "从链接导入",
        importUrlTitle: "从网络地址导入配置",
        importUrlPlaceholder: "粘贴配置文件的网络地址（以 http(s):// 开头）",
        importUrlEmpty: "请先填写网络地址",
        importUrlFetchFailed: "配置地址拉取失败：{{error}}",
        saved: "配置已保存",
        ...
        channelEditor: {
            ...
            params: "请求参数",
            paramsReady: "参数已设",
            jsonEdit: "改图用 JSON 请求体",
            jsonEditDescription: "开启后改图以 application/json 提交（xAI 及只接受 JSON 的中转站），关闭则按 OpenAI 规范用 multipart 上传。",
            empty: "点击「选择模型」拉取或手动增加模型。",
            displayName: "显示名称（可选，留空则用模型 ID）",
            capabilities: {
                image: "生图",
                video: "视频",
                text: "文本",
        ...
        paramsEditor: {
            title: "工作流请求参数",
            description: "填写提交任务时的 JSON 请求体，可用占位符在每次生成时替换为实际值。",
            placeholders: "可用占位符：",
        },
        modelSelect: {
