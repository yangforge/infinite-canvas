export default {
    ...
    config: {
        ...
        importUrlTitle: "Import settings from a URL",
        importUrlPlaceholder: "Paste the network address of the settings file (starts with http(s)://)",
        importUrlEmpty: "Enter a URL first",
        importUrlFetchFailed: "Failed to fetch the settings URL: {{error}}",
        ...
        channelEditor: {
            ...
            paramsReady: "Params set",
            jsonEdit: "JSON image edit",
            jsonEditDescription: "Turn on to send image edits as application/json (xAI and relays that reject multipart); off uses the OpenAI multipart upload.",
            empty: "Select models to fetch or manually add models.",
            displayName: "Display name (optional; falls back to the model ID)",
            capabilities: {
                image: "Image",
                video: "Video",
                text: "Text",
        ...
        paramsEditor: {
            title: "Workflow request params",
            description: "The JSON body sent when creating the task; placeholders are replaced with real values on every run.",
